...
public class PrizePotionsMIEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PrizePotionsMIEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PrizePotionsMIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PrizePotionsMIIW/InitOutcome.xml").getDocumentElement();
